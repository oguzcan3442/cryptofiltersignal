...
<body class="antialiased">
    ...
    @livewire('page-header', ['pageTitle' => "Contact Us"])
                        ...
                        <div class="row">
                            <div class="col-sm-4 res-m-bttm">
                                <div class="contact-entry">
                                    ...
                                    <p>İstanbul / Türkiye <br/>İzmir / Türkiye </p>
                                </div>
                            </div>
                            <div class="col-sm-4 res-m-bttm">
                                <div class="contact-entry">
                                    <h6>contact number</h6>
                                    <p>phone:  555-555-55-55<br/>phone:  555-555-55-55</p>
                                </div>
                            </div>
                            <div class="col-sm-4 res-m-bttm">
                                <div class="contact-entry">
